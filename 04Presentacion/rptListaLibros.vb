...
Public Class rptListaLibros
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "_04Presentacion.rptListaLibros.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptListaLibros
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptListaLibros = New rptListaLibros()
        rpt.Site = Me.Site
        Return rpt
    End Function
