...
Public Class rptLibrosAutor
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "_04Presentacion.rptLibrosAutor.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptLibrosAutor
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptLibrosAutor = New rptLibrosAutor()
        rpt.Site = Me.Site
        Return rpt
    End Function
