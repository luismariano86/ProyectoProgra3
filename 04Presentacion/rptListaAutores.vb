...
Public Class rptListaAutores
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "_04Presentacion.rptListaAutores.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptListaAutores
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptListaAutores = New rptListaAutores()
        rpt.Site = Me.Site
        Return rpt
    End Function
