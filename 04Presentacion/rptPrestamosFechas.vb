...
Public Class rptPrestamosFechas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "_04Presentacion.rptPrestamosFechas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPrestamosFechas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPrestamosFechas = New rptPrestamosFechas()
        rpt.Site = Me.Site
        Return rpt
    End Function
