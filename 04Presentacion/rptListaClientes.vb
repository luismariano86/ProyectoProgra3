...
Public Class rptListaClientes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "_04Presentacion.rptListaClientes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptListaClientes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptListaClientes = New rptListaClientes()
        rpt.Site = Me.Site
        Return rpt
    End Function
